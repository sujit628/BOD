                     ...
                     //},
                    {
                        ...
                        render: function (data, type, row) {
                            ...
                            if (status == '<span class="badge rounded bg-label-success">completed</span>') {
                                ...
                                return '<div class="d-flex align-items-sm-center justify-content-sm-center"><a class="btn btn-sm btn-icon btnEdit" href="/Assessment/ShowAssessment"><i class="ti ti-book ti-sm me-2 text-info"></i></a></div>';
                            }
                        },
                    },
                ],
