...
function retrive(id) {
    //$('#setUPFormAdminUserManageModal').addClass('show');
    //$('.btn-close').click(function () {

    //    $('#setUPFormAdminUserManageModal').removeClass('show');
    //    $('.form-control').val('');
    //});
    //$('#setUPFormAdminUserManageModal').addClass('show').css('display', 'block').attr('aria-hidden', 'false');
