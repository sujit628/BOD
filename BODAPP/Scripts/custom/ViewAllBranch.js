                ...
                n.length &&
                    ...
                    },
                    {
                        ...
                        render: function (data, type, row) {
                            ...
                            //if (count > 0) {
                         //   return (
                         //    '<div class="d-flex align-items-center"><a href="' + v + row.BD_Id + '" class="text-body"  target="_blank"><i class="ti ti-edit ti-sm me-2"></i></a><button class="btn btn-sm btn-icon me-2" data-toggle="tooltip" data-placement="top" title="AssignSMME" data-bs-target="#shareProject" data-bs-toggle="modal" onclick="ShowAllSMME(' + row.BD_Id + ')" data-bs-dismiss="modal"><i class="ti ti-user-plus ti-sm me-2"></i></button><button class="btn btn-sm btn-icon me-2" data-toggle="tooltip" data-placement="top" title="AssignUsers"   onclick="ShowAllUser(' + row.BD_Id + ')" data-bs-dismiss="modal"><i class="ti ti-users-plus ti-sm me-2"></i></button>' + List + '</div>'
                         //);
                            //}
