    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $.each(data, function (i, v) {
                var index = i + 1;
                if (count > 0) {
                    var Card = '<div class="col-xl-4 col-lg-6 col-md-6"><div class="card"><div class="card-body"><div class="d-flex justify-content-between"><h6 class="fw-normal mb-2">Total ' + v.TotalSMME + ' MSME</h6><ul id="ul_' + v.ENR_Id + '" class="list-unstyled d-flex align-items-center avatar-group mb-0"></ul></div><div class="d-flex justify-content-between align-items-end mt-1"><div class="role-heading"><h4 class="mb-1">' + v.ENR_CompanyName + '</h4><a href="/Home/EnterpriseProfieView_SMME?Id=' + v.ENR_Id + '"  class="role-edit-modal"><span>Show MSME</span></a></div><a href="/Enterprise/EnterpriseWiseSMME?M=E&Id=' + v.ENR_Id + '" class="text-muted"><i class="ti ti-edit ti-md"></i></a></div></div></div></div>'
