    ...
    if (Id > 0) {
     ...
     //   retriveprojectbudget(Id);
       // retriveProjectBudgetDetails(Id);
        //fnAcitiityListForModal(Id);
     // retriveActivityBudgetDetails(Id);
       // retriveTaskBudgetDetails(Id);
        //retriveSMMEBudgetDetails(Id);
    }
        ...
        success: function (data) {
            ...
            if (count > 0 )
            {
                $.each(data, function (i, v) {
                    ...
                    AcivityList = AcivityList +'<li class="d-flex mb-3 pb-1"> <div class="chart-progress me-3" data-color="'+["success", "danger", "warning", "info", "primary", "secondary"][Math.floor(6 * Math.random())] + '" data-series="'+v.Status+'" data-progress_variant="true"></div><div class="row w-100 align-items-center"><div class="col-9"><div class="me-2"><h6 class="mb-2">'+v.CA_ActivityName+'</h6><small>'+v.TotalTask+' Tasks</small></div></div><div class="col-3 text-end"><a href="/Stakeholder/TaskList?Id='+v.CA_ProjectId+'&CAId='+v.CA_Id+'" class="btn btn-sm btn-icon btn-label-secondary"><i class="ti ti-chevron-right scaleX-n1-rtl"></i></a></div></div></li>';
                });
            ...
            $('#ulActivity').append(AcivityList+'<li class="text-center"><a href="/Stakeholder/CreateActivityList?Id='+id+'">View all acitivies</a></li>');
            var n,
...
{
    Swal.fire({
        title: "Total Budget Exceed"+parseFloat($('#totalBdgt').val()),
        icon: "error",
        customClass: { confirmButton: "btn btn-primary waves-effect waves-light" },
        buttonsStyling: !1
    }).then((result) => {
...
//function fnAcitiityListForModal(id) {
...
//                    AcivityList ='<tr class="parent header expand rowId'+(i+1)+'" id="row'+v.CA_Id+'" title="Click to expand/collapse" ><td > <span class="sign"></span></td><td>'+v.CA_ActivityName+'</td><td colspan="2">'+v.CA_DurationFromDate+'-'+v.CA_DurationToDate+'</td><td><input type="text" class="form-control activity" value="'+v.AWB_Budget+'"  id="childAcitivity'+(i+1)+'"/><input type="hidden" id="childAcitivityId'+(i+1)+'" value="'+v.CA_Id+'"/></td></tr>'
                     
//                    fnTaskListForModal(id,v.CA_Id,(i+1));
//                    finalList=finalList+AcivityList+TaskList;
...
//            $('#tblActivity tbody').append(finalList);
...
//function fnTaskListForModal(id,task,actIndex) {


//    var _data = JSON.stringify({
//        global: {
//            TransactionType: 'SelectListTask',
//            param1: 'ProjectId',
//            param1Value: parseInt(id),
//            param2: 'ActivityId',
//            param2Value: parseInt(task),
...
//                    TaskList = TaskList +' <tr class="child-row'+task+'  childrowcls'+actIndex+'" id="child'+actIndex+'"  style="display: table-row;"><td></td> <td> </td><td>Task Name-</td><td>'+v.TD_TaskName+'</td><td><input type="text" class="form-control" id="childTask'+actIndex+(i+1)+'" value="'+v.TWB_Budget+'" /><input type="hidden" id="childTaskId'+actIndex+(i+1)+'" value="'+v.TD_Id+'"/></td></tr>'
...
{ 
    ...
    {
        Swal.fire({
            title: "Budget Cannot Be Greater Than "+parseInt($('#hdnBudget').val()),
            icon: "error",
            customClass: { confirmButton: "btn btn-primary waves-effect waves-light" },
            buttonsStyling: !1
        });
...
{   
    ...
    {
        Swal.fire({
            title: 'Please Enter Amount Less Than '+parseFloat($('#txtAvailableFund').val()),
            icon: "error",
            customClass: { confirmButton: "btn btn-primary waves-effect waves-light" },
            buttonsStyling: !1
        });
...
function cellAmntChngeForActivityBudget(t) {
    ...
    {
        Swal.fire({
            title: 'Amount Should Be Less Than '  +(Amnt+AvailBudgte),
            icon: "error",
            customClass: { confirmButton: "btn btn-primary waves-effect waves-light" },
            buttonsStyling: !1
        });
...
function cellAmntForActivityBudget(t) {
    ...
    {
        Swal.fire({
            title: 'Amount Should Be Less Than '  +AcitivityAmnt,
            icon: "error",
            customClass: { confirmButton: "btn btn-primary waves-effect waves-light" },
            buttonsStyling: !1
        });
...
{   
    ...
    {
        Swal.fire({
            title: 'Please Enter Amount Less Than '+parseFloat($('#txtAvailableFundTask').val()),
            icon: "error",
            customClass: { confirmButton: "btn btn-primary waves-effect waves-light" },
            buttonsStyling: !1
        });
...
function cellAmntForTaskBudget(t) {
    ...
    {
        Swal.fire({
            title: 'Amount Should Be Less Than '  +AvailBudgteTask,
            icon: "error",
            customClass: { confirmButton: "btn btn-primary waves-effect waves-light" },
            buttonsStyling: !1
        });
...
function cellAmntChngeForTaskBudget(t) {
    ...
    {
        Swal.fire({
            title: 'Amount Should Be Less Than '  +(Amnt+AvailBudgteTask),
            icon: "error",
            customClass: { confirmButton: "btn btn-primary waves-effect waves-light" },
            buttonsStyling: !1
        });
...
function cellAmntForSMMEBudget(t) {
    ...
    {
        Swal.fire({
            title: 'Amount Should Be Less Than '  +AvailBudgteSMME,
            icon: "error",
            customClass: { confirmButton: "btn btn-primary waves-effect waves-light" },
            buttonsStyling: !1
        });
...
{   
    ...
    {
        Swal.fire({
            title: 'Please Enter Amount Less Than '+parseFloat($('#txtAvailableFundSMME').val()),
            icon: "error",
            customClass: { confirmButton: "btn btn-primary waves-effect waves-light" },
            buttonsStyling: !1
        });
...
function cellAmntChngeForSMMEBudget(t) {
    ...
    {
        Swal.fire({
            title: 'Amount Should Be Less Than '  +(Amnt+AvailBudgteSMME),
            icon: "error",
            customClass: { confirmButton: "btn btn-primary waves-effect waves-light" },
            buttonsStyling: !1
        });
