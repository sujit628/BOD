...
!(function () {
    let o, i, t, n, l;
    t = isDarkStyle
        ? ((o = config.colors_dark.cardColor), (i = config.colors_dark.textMuted), (n = config.colors_dark.bodyColor), (l = config.colors_dark.borderColor), "dark")
        : ((o = config.colors.cardColor), (i = config.colors.textMuted), (n = config.colors.bodyColor), (l = config.colors.borderColor), "");
    var e = document.querySelector("#salesLastYear"),
        r = {
            chart: { height: 78, type: "area", parentHeightOffset: 0, toolbar: { show: !1 }, sparkline: { enabled: !0 } },
            markers: { colors: "transparent", strokeColors: "transparent" },
            grid: { show: !1 },
            colors: [config.colors.success],
            fill: { type: "gradient", gradient: { shade: t, shadeIntensity: 0.8, opacityFrom: 0.6, opacityTo: 0.25 } },
        ...
        r = {
            ...
            responsive: [
                ...
                { breakpoint: 1025, options: { plotOptions: { bar: { borderRadius: 6, columnWidth: "20%" } }, chart: { height: 80 } } },
                { breakpoint: 900, options: { plotOptions: { bar: { borderRadius: 6 } } } },
                { breakpoint: 782, options: { plotOptions: { bar: { columnWidth: "30%" } } } },
                { breakpoint: 426, options: { plotOptions: { bar: { borderRadius: 5, columnWidth: "35%" } }, chart: { height: 78 } } },
    ...
    function s(t, e) {
        ...
        return {
            ...
            plotOptions: { bar: { columnWidth: "32%", startingShape: "rounded", borderRadius: 7, distributed: !0, dataLabels: { position: "top" } } },
            ...
            responsive: [
                ...
                {
                    breakpoint: 590,
                    options: { plotOptions: { bar: { columnWidth: "61%", borderRadius: 5 } }, yaxis: { labels: { show: !1 } }, grid: { padding: { right: 0, left: -20 } }, dataLabels: { style: { fontSize: "12px", fontWeight: "400" } } },
                },
            ],
        };
    }
    ...
    var e = datachart,
        ...
        r = {
            ...
            legend: { show: !0, fontSize: "13px", position: "bottom", labels: { colors: n, useSeriesColors: !1 }, markers: { height: 10, width: 10, offsetX: -3 }, itemMargin: { horizontal: 10 }, onItemHover: { highlightDataSeries: !1 } },
    ...
    (a = document.querySelectorAll(".chart-progress")),
            ...
            a.forEach(function (o) {
                var t = config.colors[o.dataset.color],
                    ...
                    t = {
                        ...
                        plotOptions: { radialBar: { hollow: { size: "33%" }, dataLabels: { show: !1 }, track: { background: config.colors_label.secondary } } },
        ...
        (r = {
            ...
            fill: { type: "gradient", gradient: { opacityFrom: 0.6, opacityTo: 0.15, stops: [0, 95, 100] } },
            xaxis: { labels: { show: !1 }, axisBorder: { show: !1 }, axisTicks: { show: !1 }, lines: { show: !1 } },
