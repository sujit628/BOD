...
eventClick: function (e) {
    ...
    (a = e.event).url && (e.jsEvent.preventDefault(), window.open(a.url, "_blank")),
        C.show(),
        h ;
    //&& (h.innerHTML = a.id);// write retrive code here Abhijit
        ...
        //x.val(a.extendedProps).trigger("change"),
...
y.classList.contains("btn-add-event")
    ? i &&
      ((n = {
          ...
          endStr: w.value,
          display: "block",
          extendedProps: { location: P.value, guests: D.val(), calendar: x.val(), description: M.value },
      }),
