                        ...
                        o
                            .typeahead(
                                { hint: !1, classNames: { menu: "tt-menu navbar-search-suggestion", cursor: "active", suggestion: "suggestion d-flex justify-content-between px-3 py-2 w-100" } },
                                {
                                    ...
                                    source: t(a.Setup),
                                    templates: {
                                        header: '<h6 class="suggestions-header text-primary mb-0 mx-3 mt-3 pb-2">Setup</h6>',
                                        suggestion: function ({ url: e, icon: t, name: a }) {
                                            return '<a href="' + e + '"><div><i class="ti ' + t + ' me-2"></i><span class="align-middle">' + a + "</span></div></a>";
                                        },
                        notFound: '<div class="not-found px-3 py-2"><h6 class="suggestions-header text-primary mb-2">Setup</h6><p class="py-2 mb-0"><i class="ti ti-alert-circle ti-xs me-2"></i> No Results Found</p></div>',
                        },
            },
                                {
                                    name: "files",
