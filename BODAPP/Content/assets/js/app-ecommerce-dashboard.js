"use strict";
(function () {
    //var seriseDataTask =[33];
    //var seriseLblTask =  ["Progress"];
    retriveTaskDetails();
    retriveAssesmentDetails();
    retriveBEELevelDetails();
    retriveEmployeeGender() ;
    retriveProjectDetails();
    let e, t, o, a, i;
    a = (isDarkStyle
    ...
    var s = { donut: { series1: config.colors.success, series2: "#28c76fb3", series3: "#28c76f80", series4: config.colors_label.success } },
        ...
        n = {
            ...
            plotOptions: {
                radialBar: {
                    ...
                    dataLabels: { name: { show: !1 }, value: { fontSize: "22px", color: o, fontWeight: 500, offsetY: -5 } },
                },
            },
        ...
        r = (null !== r && new ApexCharts(r, n).render(), document.querySelector("#generatedChartTaskStatus")),
        
     labelss=  (typeof  seriseLblTask === 'undefined')  ? [] : seriseLblTask  ,
     seriess=  (typeof  seriseDataTask === 'undefined')  ? [] : seriseDataTask,
        n = {
            chart: { height: 147, width: 130, parentHeightOffset: 0, type: "donut" },
            labels:(typeof  seriseLblTask === 'undefined')  ? [] : seriseLblTask ,
            series: (typeof  seriseDataTask === 'undefined')  ? [] : seriseDataTask,
        ...
        //        r = (null !== n && new ApexCharts(n, s).render(), document.querySelector("#projectAllocationChart")),

        //DataProjectEnr=  (typeof  seriseDataProject === 'undefined')  ? [] : seriseDataProject,
        // LblProjectEnr=  (typeof  seriseLblProject === 'undefined')  ? [] : seriseLblProject,

        //n = {
        //    chart: { height: 202, parentHeightOffset: 0, type: "bar", toolbar: { show: !1 } },
        //    plotOptions: { bar: { barHeight: "50%", columnWidth: "28%", startingShape: "rounded", endingShape: "rounded", borderRadius: 4, distributed: !0 } },
        //    grid: { show: !1, padding: { top: -30, bottom: 0, left: -10, right: -10 } },
        //    colors: ['#7367f0','#7367f0','#7367f0'],
        //    dataLabels: { enabled: !1 },
        //    series: [{ data: DataProjectEnr }],
        //    legend: { show: !1 },
        //    xaxis: { categories: LblProjectEnr,
        //        axisBorder: { show: !1 }, axisTicks: { show: !1 }, labels: { style: { colors: '#7367f0', fontSize: "12px", fontFamily: "Public Sans" } } },
        //    yaxis: { labels: { show: !1 } },
        //    tooltip: { enabled: !1 },
        //    responsive: [{ breakpoint: 1025, options: { chart: { height: 170 } } }],
        //},

        r = (null !== r && new ApexCharts(r, n).render(), document.querySelector("#generatedChartGenderStatus")),
        
     //labelss=  (typeof  seriseLbl === 'undefined')  ? [] : seriseLbl,
   
        n = {
            chart: { height: 147, width: 130, parentHeightOffset: 0, type: "donut" },
            labels: ["Male", "Female"],
            series: (typeof  seriseDataGenderGrp === 'undefined')  ? [] : seriseDataGenderGrp,
         ...
         r = (null !== r && new ApexCharts(r, n).render(), document.querySelector("#generatedChartAssessmentsStatus")),
        
     labelss=  (typeof  seriseLblAssesment === 'undefined')  ? [] : seriseLblAssesment,
     seriess=  (typeof  seriseDataAssesment === 'undefined')  ? [] : seriseDataAssesment,
        n = {
            chart: { height: 147, width: 130, parentHeightOffset: 0, type: "donut" },
            labels: labelss,
            series: seriess,
     ...
     labelss=  (typeof  seriseLbl === 'undefined')  ? [] : seriseLbl,
     seriess=  (typeof  seriseData === 'undefined')  ? [] : seriseData,
        n = {
            chart: { height: 147, width: 130, parentHeightOffset: 0, type: "donut" },
            labels:  labelss,
            series:  seriess,
                    ...
                    donut: {
                        ...
                        labels: {
                            ...
                            total: {
                                ...
                                fontFamily: "Public Sans",
                                formatter: function (e) {
                                    return  ((sumFundBudget === 'undefined')  ? 0 : sumFundBudget);
                                },
                            },
                        },
                    },
        ...
        r = (null !== n && new ApexCharts(n, s).render(), document.querySelector("#reportBarChart")),
          DataBEELevel=  (typeof  seriseDataBEELevel === 'undefined')  ? [] : seriseDataBEELevel,
         LblBEELevel=  (typeof  seriseLblBEELevel === 'undefined')  ? [] : seriseLblBEELevel,
        ...
        n = {
            ...
            dataLabels: { enabled: !1 },
            series: [{ data: DataBEELevel }],
            legend: { show: !1 },
            xaxis: { categories: LblBEELevel,
             axisBorder: { show: !1 }, axisTicks: { show: !1 }, labels: { style: { colors: t, fontSize: "13px" } } },
            yaxis: { labels: { show: !1 } },
            responsive: [
    ...
    s.length &&
        s.DataTable({
            ...
            columns: [{ data: "" }, { data: "invoice_id" }, { data: "invoice_status" }, { data: "total" }, { data: "issued_date" }, { data: "invoice_status" }, { data: "action" }],
            columnDefs: [
                {
                    className: "control",
            ...
            order: [[1, "asc"]],
            dom:
                '<"row ms-2 me-3"<"col-12 col-md-6 d-flex align-items-center justify-content-center justify-content-md-start gap-2"l<"dt-action-buttons text-xl-end text-lg-start text-md-end text-start mt-md-0 mt-3"B>><"col-12 col-md-6 d-flex align-items-center justify-content-end flex-column flex-md-row pe-3 gap-md-2"f<"invoice_status mb-3 mb-md-0">>>t<"row d-flex align-items-center mx-2"<"col-sm-12 col-md-6"i><"col-sm-12 col-md-6 mt-1"p>>',
            displayLength: 7,
