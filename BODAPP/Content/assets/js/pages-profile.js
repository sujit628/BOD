                        ...
                        return (
                            ...
                            (s
                                ...
                                : '<span class="avatar-initial rounded-circle bg-label-' +
                                  ...
                                  '">' +
                                  (s = (((s = (d = t.project_name).match(/\b\w/g) || []).shift() || "") + (s.pop() || "")).toUpperCase()) +
                                  "</span>") +
                ...
                },
                {
                    ...
                    render: function (e, a, t, r) {
                        for (var s = t.team, d = '<div class="d-flex align-items-center avatar-group">', n = 0; n < s.length; n++)
                            d += '<div class="avatar avatar-sm"><img src="' + assetsPath + "img/avatars/" + s[n] + '" alt="Avatar" class="rounded-circle pull-up"></div>';
                        return (d += "</div>");
                    },
                },
                {
