...
(function () {
    ...
    var s = document.querySelector("#swiper-with-pagination-cards"),
        s = (s && new Swiper(s, { loop: !0, autoplay: { delay: 3500, disableOnInteraction: !1 }, pagination: { clickable: !0, el: ".swiper-pagination" } }),
        ...
        s = (null !== s && new ApexCharts(s, i).render(), document.querySelector("#projectAllocationChart")),
