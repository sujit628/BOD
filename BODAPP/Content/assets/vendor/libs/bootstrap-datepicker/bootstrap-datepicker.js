                                ...
                                s.startDate !== -1 / 0 &&
                                    (s.startDate
                                        ? s.startDate instanceof Date
                                            ...
                                            : (s.startDate = g.parseDate(s.startDate, o, s.language, s.assumeNearbyYear))
                                        : (s.startDate = -1 / 0)),
                                    s.endDate !== 1 / 0 &&
                                        (s.endDate
                                            ? s.endDate instanceof Date
                                                ? (s.endDate = this._local_to_utc(this._zero_time(s.endDate)))
                                                : (s.endDate = g.parseDate(s.endDate, o, s.language, s.assumeNearbyYear))
                                            : (s.endDate = 1 / 0)),
                            ...
                            fillDow: function () {
                                if (this.o.showWeekDays) {
                                    ...
                                    for (this.o.calendarWeeks && (i += '<th class="cw">&#160;</th>') ; e < this.o.weekStart + 7;)
                                        (i += '<th class="dow'), -1 !== t.inArray(e, this.o.daysOfWeekDisabled) && (i += " disabled"), (i += '">' + f[this.o.language].daysMin[e++ % 7] + "</th>");
                            ...
                            setViewMode: function (t) {
                                (this.viewMode = t),
                                    this.picker
                                        .children("div")
                                        .hide()
                                        .filter(".datepicker-" + g.viewModes[this.viewMode].clsName)
                                        .show(),
                                    this.updateNavArrows(),
                                ...
                                if (!this.updating) {
                                    ...
                                    if (a !== e) {
                                        ...
                                        if (-1 !== o) {
                                            ...
                                            else if (s > this.dates[h]) for (; h < l && s > this.dates[h] && (this.pickers[h].element.val() || "").length > 0;) this.pickers[h++].setUTCDate(s);
                                    ...
                                    this.each(function () {
                                        ...
                                        if (!n) {
                                            var r = (function (e, i) {
                                                ...
                                                c = t.extend({}, u, d, r, o);
                                            e.hasClass("input-daterange") || c.inputs ? (t.extend(c, { inputs: c.inputs || e.find("input").toArray() }), (n = new l(this, c))) : (n = new h(this, c)), e.data("datepicker", n);
                                }
