                ...
                t.exports = (function () {
                        ...
                        return (
                            ...
                            (function (t, e) {
                                if (t) {
                                    ...
                                    return (
                                        "Object" === n && t.constructor && (n = t.constructor.name), "Map" === n || "Set" === n ? Array.from(t) : "Arguments" === n || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n) ? l(t, e) : void 0
                                    );
                                }
                            })(t) ||
                            (function () {
                        ...
                        if (t.getBoundingClientRect || t === window) {
                            ...
                            if (
                                (t !== window && t.parentNode && t !== x()
                                    ? ((a = (r = t.getBoundingClientRect()).top), (l = r.left), (s = r.bottom), (u = r.right), (d = r.height), (h = r.width))
                                    : ((a = 0), (l = 0), (s = window.innerHeight), (u = window.innerWidth), (d = window.innerHeight), (h = window.innerWidth)),
                    ...
                    function A(t, e, n, o) {
                        for (var i = 0, r = 0, a = t.children; r < a.length;) {
                            if ("none" !== a[r].style.display && a[r] !== Ft.ghost && (o || a[r] !== Ft.dragged) && w(a[r], n.draggable, t, !1)) {
                                if (i === e) return a[r];
                                i++;
                            }
                            r++;
                    ...
                    function N(t, e) {
                        for (var n = t.lastElementChild; n && (n === Ft.ghost || "none" === _(n, "display") || (e && !b(n, e))) ;) n = n.previousElementSibling;
                        return n || null;
                    }
                    function I(t, e) {
                        var n = 0;
                            ...
                            animateAll: function (e) {
                                ...
                                n.forEach(function (t) {
                                    ...
                                    d && ((l.top -= d.f), (l.left -= d.e)),
                                        ...
                                        R(l, a) || ((n.prevFromRect = a), (n.prevToRect = l), e || (e = o.options.animation), o.animate(n, u, l, e)),
                                        e &&
                                            ((i = !0),
                                            (r = Math.max(r, e)),
                    ...
                    function G(t) {
                        ...
                        if ((n = n || (o && o[H]))) {
                            ...
                            !window.CustomEvent || c || u ? (b = document.createEvent("Event")).initEvent(i, !0, !0) : (b = new CustomEvent(i, { bubbles: !0, cancelable: !0 })),
                                (b.to = l || o),
                                (b.from = s || o),
                                (b.item = r || o),
                                (b.clone = a),
                    ...
                    function V(t) {
                        G(e({ putSortable: ct, cloneEl: nt, targetEl: Z, rootEl: J, oldIndex: it, oldDraggableIndex: at, newIndex: rt, newDraggableIndex: lt }, t));
                    }
                    var Z,
                        $,
                        Q,
                        ...
                        kt = function (t, e) {
                            ...
                            return i && ("block" === a.display || "flex" === a.display || "table" === a.display || "grid" === a.display || (s >= o && "none" === n[Nt]) || (r && "none" === n[Nt] && s + c > o))
                                ? "vertical"
                                : "horizontal";
                        },
                        Rt = function (t) {
                    ...
                    function Ft(t, e) {
                        ...
                        (this.nativeDraggable = !e.forceFallback && It),
                            ...
                            e.supportPointer ? v(t, "pointerdown", this._onTapStart) : (v(t, "mousedown", this._onTapStart), v(t, "touchstart", this._onTapStart)),
                    ...
                    function Ht(t, e, n, o, i, r, a, l) {
                        var s,
                            ...
                            f = h.options.onMove;
                        return (
                            !window.CustomEvent || c || u ? (s = document.createEvent("Event")).initEvent("move", !0, !0) : (s = new CustomEvent("move", { bubbles: !0, cancelable: !0 })),
                            (s.to = e),
                            (s.from = t),
                            (s.dragged = n),
                            (s.draggedRect = o),
                    ...
                    (Ft.prototype = {
                            ...
                            if (t.cancelable) {
                                ...
                                if (
                                    ...
                                    if (((it = I(l)), (at = I(l, o.draggable)), "function" == typeof c)) {
                                        if (c.call(this, t, l, this)) return V({ sortable: e, rootEl: s, name: "filter", targetEl: l, toEl: n, fromEl: n }), q("filter", e, { evt: t }), void (i && t.cancelable && t.preventDefault());
                                    } else if (
                                        c &&
                                        (c = c.split(",").some(function (o) {
                                            if ((o = w(s, o.trim(), n, !1))) return V({ sortable: e, rootEl: o, name: "filter", targetEl: l, fromEl: n, toEl: n }), q("filter", e, { evt: t }), !0;
                                    }))
                                    )
                                ...
                                if (
                                    ...
                                    (o = function () {
                                        q("delayEnded", i, { evt: t }),
                                            Ft.eventCanceled
                                                ? i._onDrop()
                                                : (i._disableDelayedDragEvents(), !d && i.nativeDraggable && (Z.draggable = !0), i._triggerDragStart(t, e), V({ sortable: i, name: "choose", originalEvent: t }), S(Z, a.chosenClass, !0));
                                }),
                                    ...
                                    d && this.nativeDraggable && ((this.options.touchStartThreshold = 4), (Z.draggable = !0)),
                        ...
                        _delayedDragTouchMoveHandler: function (t) {
                            ...
                            Math.max(Math.abs(e.clientX - this._lastX), Math.abs(e.clientY - this._lastY)) >= Math.floor(this.options.touchStartThreshold / ((this.nativeDraggable && window.devicePixelRatio) || 1)) &&
                        ...
                        _dragStarted: function (t, e) {
                            if (((Et = !1), J && Z)) {
                                q("dragStarted", this, { evt: e }), this.nativeDraggable && v(document, "dragover", jt);
                                var n = this.options;
                                !t && S(Z, n.dragClass, !1), S(Z, n.ghostClass, !0), (Ft.active = this), t && this._appendGhost(), V({ sortable: this, name: "start", originalEvent: e });
                            } else this._nulling();
                        },
                        _emulateDragOver: function () {
                            if (dt) {
                                ...
                                if ((Z.parentNode[H]._isOutsideThisEl(t), e))
                                    do {
                                        if (e[H] && e[H]._onDragOver({ clientX: dt.clientX, clientY: dt.clientY, target: t, rootEl: e }) && !this.options.dragoverBubble) break;
                                        t = e;
                        ...
                        _onTouchMove: function (t) {
                            if (ut) {
                                ...
                                if (Q) {
                                    r ? ((r.e += c - (ht || 0)), (r.f += u - (ft || 0))) : (r = { a: 1, b: 0, c: 0, d: 1, e: c, f: u });
                        ...
                        _appendGhost: function () {
                            if (!Q) {
                                var t = this.options.fallbackOnBody ? document.body : J,
                                    ...
                                    n = this.options;
                                if (At) {
                                    for (wt = t; "static" === _(wt, "position") && "none" === _(wt, "transform") && wt !== document;) wt = wt.parentNode;
                                    wt !== document.body && wt !== document.documentElement ? (wt === document && (wt = x()), (e.top += wt.scrollTop), (e.left += wt.scrollLeft)) : (wt = x()), (Tt = P(wt));
                                }
                                S((Q = Z.cloneNode(!0)), n.ghostClass, !1),
                                    ...
                                    (Ft.ghost = Q),
                                    t.appendChild(Q),
                                    _(Q, "transform-origin", (pt / parseInt(Q.style.width)) * 100 + "% " + (gt / parseInt(Q.style.height)) * 100 + "%");
                            }
                        },
                        _onDragStart: function (t, e) {
                            ...
                            q("dragStart", this, { evt: t }),
                                Ft.eventCanceled
                                    ? this._onDrop()
                                    : (q("setupClone", this),
                                      Ft.eventCanceled || ((nt = B(Z)).removeAttribute("id"), (nt.draggable = !1), (nt.style["will-change"] = ""), this._hideClone(), S(nt, this.options.chosenClass, !1), (Ft.clone = nt)),
                                      (n.cloneId = Gt(function () {
                                          q("clone", n), Ft.eventCanceled || (n.options.removeCloneOnHide || J.insertBefore(nt, Z), n._hideClone(), V({ sortable: n, name: "clone" }));
                                      })),
                                      !e && S(Z, i.dragClass, !0),
                                      e
                        ...
                        _onDragOver: function (t) {
                            var n,
                                ...
                                g = !1;
                            if (!xt) {
                                if ((void 0 !== t.preventDefault && t.cancelable && t.preventDefault(), (l = w(l, s.draggable, a, !0)), j("dragOver"), Ft.eventCanceled)) return g;
                                ...
                                if (((Dt = !1), u && !s.disabled && (d ? h || (i = $ !== J) : ct === this || ((this.lastPutMode = st.checkPull(this, u, Z, t)) && c.checkPut(this, u, Z, t))))) {
                                    if (((r = "vertical" === this._getDirection(t, l)), (n = O(Z)), j("dragOverValid"), Ft.eventCanceled)) return g;
                                    if (i) return ($ = J), F(), this._hideClone(), j("revert"), Ft.eventCanceled || (tt ? J.insertBefore(Z, tt) : J.appendChild(Z)), L(!0);
                                    ...
                                    if (
                                        ...
                                        if (v === Z) return L(!1);
                                        if ((v && a === t.target && (l = v), l && (o = O(l)), !1 !== Ht(J, a, Z, n, l, o, t, !!l)))
                                            return F(), v && v.nextSibling ? a.insertBefore(Z, v.nextSibling) : a.appendChild(Z), ($ = a), K(), L(!0);
                                    } else if (
                                        v &&
                                        (function (t, e, n) {
                                            var o = O(A(n.el, 0, n.options, !0));
                                            return e ? t.clientX < o.left - 10 || (t.clientY < o.top && t.clientX < o.right) : t.clientY < o.top - 10 || (t.clientY < o.bottom && t.clientX < o.left);
                                    })(t, r, this)
                                    ) {
                                        var m = A(a, 0, s, !0);
                                        if (m === Z) return L(!1);
                                        if (((o = O((l = m))), !1 !== Ht(J, a, Z, n, l, o, t, !1))) return F(), a.insertBefore(Z, m), ($ = a), K(), L(!0);
                                        ...
                                        if (
                                            ...
                                            0 !== (E = Wt(t, l, o, r, C ? 1 : s.swapThreshold, null == s.invertedSwapThreshold ? s.swapThreshold : s.invertedSwapThreshold, Ct, mt === l)))
                                        ) {
                                            var k = I(Z);
                                            do {
                                                (k -= E), (y = $.children[k]);
                            ...
                            function L(e) {
                                return (
                                    ...
                                    e &&
                                        ...
                                        p !== f && (S(Z, ct ? ct.options.ghostClass : u.options.ghostClass, !1), S(Z, s.ghostClass, !0)),
                                    ...
                                    s.dragoverBubble || t.rootEl || l === document || (Z.parentNode[H]._isOutsideThisEl(t.target), !e && Bt(t)),
                                    !s.dragoverBubble && t.stopPropagation && t.stopPropagation(),
                                    (g = !0)
                                );
                            }
                            function K() {
                                (rt = I(Z)), (lt = I(Z, s.draggable)), V({ sortable: p, name: "change", toEl: a, newIndex: rt, newDraggableIndex: lt, originalEvent: t });
                            }
                        },
                                ...
                                Ft.eventCanceled ||
                                    ...
                                    t &&
                                        ...
                                        Z &&
                                            ...
                                            V({ sortable: this, name: "unchoose", toEl: $, newIndex: null, newDraggableIndex: null, originalEvent: t }),
                                            J !== $
                                                ? (rt >= 0 &&
                                                  ...
                                                  ct && ct.save())
                                                : rt !== it && rt >= 0 && (V({ sortable: this, name: "update", toEl: $, originalEvent: t }), V({ sortable: this, name: "sort", toEl: $, originalEvent: t })),
                                            Ft.active && ((null != rt && -1 !== rt) || ((rt = it), (lt = at)), V({ sortable: this, name: "end", toEl: $, originalEvent: t }), this.save())))),
                                this._nulling();
                        },
                        _nulling: function () {
                            q("nulling", this),
                                (J = Z = $ = Q = tt = nt = et = ot = ut = dt = vt = rt = lt = it = at = mt = bt = ct = st = Ft.dragged = Ft.ghost = Ft.clone = Ft.active = null),
                        ...
                        _showClone: function (t) {
                            if ("clone" === t.lastPutMode) {
                                if (ot) {
                                    ...
                                    Z.parentNode != J || this.options.group.revertClone ? (tt ? J.insertBefore(nt, tt) : J.appendChild(nt)) : J.insertBefore(nt, Z),
                            ...
                            if (e.scroll) {
                                ...
                                do {
                                    var f = h,
                                        ...
                                        A = f.scrollTop;
                                    f === c
                                        ? ((E = y < S && ("auto" === T.overflowX || "scroll" === T.overflowX || "visible" === T.overflowX)),
                                          (D = w < C && ("auto" === T.overflowY || "scroll" === T.overflowY || "visible" === T.overflowY)))
                                        : ((E = y < S && ("auto" === T.overflowX || "scroll" === T.overflowX)), (D = w < C && ("auto" === T.overflowY || "scroll" === T.overflowY)));
                                        ...
                                        (0 == N && 0 == I) ||
                                            ...
                                            (te[d].pid = setInterval(
                                                function () {
                                                    ...
                                                    ("function" == typeof i && "continue" !== i.call(Ft.dragged.parentNode[H], n, e, t, Qt, te[this.layer].el)) || Y(te[this.layer].el, n, e);
                                                }.bind({ layer: d }),
                                                24
                                            )))),
                                        d++;
                                    ...
                                    (t.prototype = {
                                        ...
                                        drop: function () {
                                            this.sortable.nativeDraggable
                                                ...
                                                : (m(document, "pointermove", this._handleFallbackAutoScroll), m(document, "touchmove", this._handleFallbackAutoScroll), m(document, "mousemove", this._handleFallbackAutoScroll)),
                                                oe(),
                                                ne(),
                                                clearTimeout(E),
                                                (E = void 0);
                                        ...
                                        drop: function (t) {
                                            ...
                                            ie && S(ie, d.swapClass, !1),
                                                ie &&
                                                    ...
                                                    (r = (e = c).parentNode),
                                                    (a = n.parentNode),
                                                    r && a && !r.isEqualNode(n) && !a.isEqualNode(e) && ((o = I(e)), (i = I(n)), r.isEqualNode(a) && o < i && i++, r.insertBefore(n, r.children[o]), a.insertBefore(e, a.children[i])),
                                                    u.animateAll(),
                                                    u !== l && l.animateAll());
                                        },
                                        nulling: function () {
                            ...
                            new (function () {
                                function t(t) {
                                    ...
                                    t.options.avoidImplicitDeselect ||
                                        (t.options.supportPointer ? v(document, "pointerup", this._deselectMultiDrag) : (v(document, "mouseup", this._deselectMultiDrag), v(document, "touchend", this._deselectMultiDrag))),
                                    ...
                                    (t.prototype = {
                                        ...
                                        clone: function (t) {
                                            var e = t.sortable,
                                                ...
                                                i = t.cancel;
                                            this.isMultiDrag && (this.options.removeCloneOnHide || (pe.length && ue === e && (ye(!0, n), o("clone"), i())));
                                        },
                                        ...
                                        revert: function (t) {
                                            ...
                                            pe.length > 1 &&
                                                (pe.forEach(function (t) {
                                                    o.addAnimationState({ target: t, rect: me ? O(t) : i }), F(t), (t.fromRect = i), e.removeAnimationState(t);
                                                }),
                                                (me = !1),
                                                (function (t, e) {
                                                    ...
                                                    if ((me || we(), pe.length > 1)) {
                                                        ...
                                                        i._showClone(e),
                                                            i.options.animation &&
                                                                ...
                                                                c &&
                                                                ge.forEach(function (t) {
                                                                    i.addAnimationState({ target: t, rect: he }), (t.fromRect = he), (t.thisAnimationDuration = null);
                                                                });
                                                    } else i._showClone(e);
                                            }
                                        },
                                        ...
                                        drop: function (t) {
                                            ...
                                            if (e) {
                                                var c = this.options,
                                                    u = o.children;
                                                if (!be)
                                                    if ((c.multiDragKey && !this.multiDragKeyDown && this._deselectMultiDrag(), S(de, c.selectedClass, !~pe.indexOf(de)), ~pe.indexOf(de)))
                                                        pe.splice(pe.indexOf(de), 1), (ce = null), G({ sortable: i, rootEl: n, name: "deselect", targetEl: de, originalEvent: e });
                                                    else {
                                                        if ((pe.push(de), G({ sortable: i, rootEl: n, name: "select", targetEl: de, originalEvent: e }), e.shiftKey && ce && i.el.contains(ce))) {
                                                            var d,
                                                                h,
                                                                f = I(ce),
                                                                p = I(de);
                                                            if (~f && ~p && f !== p)
                                                                for (p > f ? ((h = f), (d = p)) : ((h = p), (d = f + 1)) ; h < d; h++)
                                                                    ~pe.indexOf(u[h]) || (S(u[h], c.selectedClass, !0), pe.push(u[h]), G({ sortable: i, rootEl: n, name: "select", targetEl: u[h], originalEvent: e }));
                                                        } else ce = de;
                                                        ue = s;
                                                    }
                                        ...
                                        _deselectMultiDrag: function (t) {
                                            if (!((void 0 !== be && be) || ue !== this.sortable || (t && w(t.target, this.options.draggable, this.sortable.el, !1)) || (t && 0 !== t.button)))
                                                for (; pe.length;) {
                                                    var e = pe[0];
                                                    S(e, this.options.selectedClass, !1), pe.shift(), G({ sortable: this.sortable, rootEl: this.sortable.el, name: "deselect", targetEl: e, originalEvent: t });
                                                }
                                        },
                                            ...
                                            return (
                                                pe.forEach(function (o) {
                                                    ...
                                                    e.push({ multiDragElement: o, index: o.sortableIndex }),
                                                        (i = me && o !== de ? -1 : me ? I(o, ":not(." + t.options.selectedClass + ")") : I(o)),
